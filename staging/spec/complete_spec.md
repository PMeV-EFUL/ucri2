...
- [UCRI2 Systemarchitektur](#ucri2-systemarchitektur)
  ...
  * [Vermittlungsebene](#vermittlungsebene)
    + [Kommunikationsdomänen](#kommunikationsdomanen)
...
- [UCRI2 Peer-2-Peer Kommunikationsprotokoll](#ucri2-peer-2-peer-kommunikationsprotokoll)
...
- [UCRI2 APIs](#ucri2-apis)
  ...
  * [Peer-to-Peer-API (P2P-API)](#peer-to-peer-api-p2p-api)
    + [Endpunkt /token - HTTP GET](#endpunkt-token---http-get-1)
    + [Endpunkt /info - HTTP GET](#endpunkt-info---http-get-1)
    + [Endpunkt /registry - HTTP GET](#endpunkt-registry---http-get-1)
      - [Direkter Versand von Verfügbarkeits-Status-Nachrichten](#direkter-versand-von-verfugbarkeits-status-nachrichten)
    + [Endpunkt /messaging/send - HTTP POST](#endpunkt-messagingsend---http-post-1)
