...
versioniert (siehe [UCRI2 Versionierung](./versioning.md#versionierung)). Dies erlaubt die freie Weiterentwicklung jeder einzelnen UCRI2-App.
...
2. Client-Authentifizierung. Die Vertrauensbeziehung zum KT oder UCRM in der Client-Rolle basiert auf dem Object Identifier (OID) des Clients (siehe [Adressierungskonzept](./addressing_concept.md#adressierungskonzept)) und wird durch Client-Zertifikat abgesichert. Die OID des Clients ist im Client-Zertifikat verankert.
